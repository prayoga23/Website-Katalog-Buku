<?php
  ...
  if(isset($_POST["katakunci"])){
    ...
    $_SESSION['katakunci_kategori_buku'] = $katakunci_kategori;
  }
  if(isset($_SESSION['katakunci_kategori_buku'])){
    $katakunci_kategori = $_SESSION['katakunci_kategori_buku'];
  }else{
    unset($_SESSION['katakunci_kategori_buku']);
  }
?>
    ...
    <section class="content">
            <div class="card">
                ...
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      ...
                      <th width="80%"><center>Kategori Buku</center></th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td align="center">
                        <a href="index.php?include=edit-kategori-buku&data=<?php echo $id_kategori_buku;?>" class="btn btn-xs btn-warning"><i class="fas fa-edit"></i> Edit</a>
                        <a href="javascript:if(confirm('Anda yakin ingin menghapus data <?php echo $kategori_buku; ?>?')) window.location.href ='index.php?include=kategori-buku&aksi=hapus&data=<?php echo $id_kategori_buku;?>¬if=hapusberhasil'" class="btn btn-xs btn-danger"><i class="fas fa-trash"></i> Hapus</a>
                      </td>
                    </tr>
                    <?php $no++;} ?>
                  </tbody>
              ...
              <?php
                ...
                $sql_jum = "SELECT `id_kategori_buku`, `kategori_buku` 
                            FROM `kategori_buku` ";
                if (!empty($katakunci_kategori)){
