<?php
  ...
  if(isset($_POST["katakunci"])){
    ...
    $_SESSION['katakunci_tag'] = $katakunci_kategori;
  }
  if(isset($_SESSION['katakunci_tag'])){
    $katakunci_kategori = $_SESSION['katakunci_tag'];
  }else{
                    ...
                    <table class="table table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th width="80%"><center>Tag</center></th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td align="center">
                            ...
                            <?php echo $tag; ?>?'))window.location.href =
                            'index.php?include=tag&aksi=hapus&data=
                            <?php echo
                            $id_tag; ?>&notif=hapusberhasil'"
                            class="btn btn-xs btn-danger" title="Hapus"><i class="fas fa-trash"></i>
                            Hapus</a>
                          </td>
                        </tr><?php $no++; } ?>
                      </tbody>
