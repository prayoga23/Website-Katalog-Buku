<?php
  ...
  if(isset($_POST["katakunci"])){
    ...
    $_SESSION['katakunci_penerbit'] = $katakunci_kategori;
  }
  if(isset($_SESSION['katakunci_penerbit'])){
    $katakunci_kategori = $_SESSION['katakunci_penerbit'];
  }else{
...
?>
        ...
        <section class="content">
                    ...
                    <table class="table table-bordered">
                      <thead>                  
                        <tr>
                          ...
                          <th width="20%"><center>Penerbit</center></th>
                          <th width="60%"><center>Alamat</center></th>
                      ...
                      <tbody>
                        <?php
                          ...
                          $sql_p = "SELECT `id_penerbit`,`penerbit`, `alamat` 
                                    FROM `penerbit`";
                        ...
                        <tr>
                          ...
                          <td align="center">
                            ...
                            'index.php?include=penerbit&aksi=hapus&data=<?php echo
                            $id_penerbit; ?>&notif=hapusberhasil'"
              ...
              <?php
                ...
                $sql_jum = "SELECT `id_penerbit`, `penerbit`, `alamat` 
                            FROM `penerbit` ";
                if (!empty($katakunci_kategori)){
