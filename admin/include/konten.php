<?php
  if(isset($_POST["katakunci"])){
    ...
    $_SESSION['katakunci_konten'] = $katakunci_kategori;
  }
  if(isset($_SESSION['katakunci_konten'])){
    $katakunci_kategori = $_SESSION['katakunci_konten'];
  }else{
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td align="center">
                            ...
                            <a href="index.php?include=edit-konten&data=<?php echo $id_konten; ?>" class="btn btn-xs btn-warning" title="Edit"><i class="fas fa-edit"></i>Edit</a>
                          </td>
                        </tr>
                        <?php $no++; } ?>
                      </tbody>
