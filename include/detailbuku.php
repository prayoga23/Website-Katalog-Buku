                ...
                <?php
                  if(isset($_GET['data'])){
                    ...
                    $sql_d = "SELECT `b`.`cover`,`k`.`kategori_buku`,`b`.`judul`, `b`.`pengarang`, `b`.`tahun_terbit`,
                                    `p`.`penerbit`, `b`.`sinopsis`, `b`.`id_kategori_buku` 
                              FROM `buku` `b`
                  ...
                  <?php
                    if (!empty($array_tag)) {
                      ...
                      for ($i=0; $i < $jumlah_tag ; $i++) { 
                        if ($i==($jumlah_tag-1)) { ?>
                          <a href="index.php?include=daftar-buku-tag&<?php echo $array_idtag[$i]; ?>">
                            <?php echo $array_tag[$i]; ?>
                          </a>
                          <?php
                        }else{ ?>
                          <a href="index.php?include=daftar-buku-tag&<?php echo $array_idtag[$i]; ?>">
